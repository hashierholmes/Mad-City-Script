...
_G.AutoRob = true
queue_on_teleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/hashierholmes/Mad-City-Script/refs/heads/main/auto.lua'))()")
...
function shop()
    local a,b = pcall(function()
        ...
        local servers = {}
        local req = request({Url = "https://games.roblox.com/v1/games/91282350711571/servers/Public?sortOrder=Desc&limit=100&excludeFullGames=true"})
